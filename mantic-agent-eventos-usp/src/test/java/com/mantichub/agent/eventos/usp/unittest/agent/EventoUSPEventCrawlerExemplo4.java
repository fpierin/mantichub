...
public class EventoUSPEventCrawlerExemplo4 {
	
	private final static String arquivo = "src/test/resources/exemplo4.html";
	...
	public void verificaDataInicio() throws Exception {
		final Event crawler = new EventoUspEventAdapter(fromFile(arquivo), null);
		final Date valorEsperado = new SimpleDateFormat("dd/MM/yy").parse("27/08/16");
	...
	public void verificaLongitude() throws Exception {
		final Event crawler = new EventoUspEventAdapter(fromFile(arquivo), null);
		final Double valorEsperado = -47.299116;
