...
public class DatastoreInferenceTest2 {
	
	private static final String path = "/opt/apps/mantichub/datastore2";
...
//		doInferenceQuery();
		...
		final DatastoreRepository datastoreRepository = new DatastoreRepositoryImpl(path, "teste2");
		final ResultSet query = datastoreRepository.query("SELECT * { ?s ?p ?o }");
