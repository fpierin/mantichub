...
import static com.mantichub.agent.eventos.guiadasemana.config.Configuration.MAX_CONNECTION_PER_ROUTE;
import static com.mantichub.agent.eventos.guiadasemana.config.Configuration.MAX_CONNECTION_TOTAL;
import static com.mantichub.agent.eventos.guiadasemana.config.Configuration.MAX_RETRY_ATTEMPTS;
	...
	private Module bindingsModule() {
		return new AbstractModule() {
			...
			protected void configure() {
				...
				bind(Agent.class).to(GuiaDaSemanaAgent.class).asEagerSingleton();
			}
		};
	}
