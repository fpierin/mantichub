...
public class EventoUSPEventCrawlerExemplo3 {
	...
	public void verificaPrice() throws Exception {
		final EventResource crawler = new GuiaDaSemanaEventAdapter(fromFile(arquivo));
	...
	public void verificaDataInicio() throws Exception {
		...
		GuiaDaSemanaEventAdapter.START_DATE_PATTERN = "<td>(\\d{2}/\\d{2}/\\d{2})( - \\d{2}/\\d{2}/\\d{2})? \\| \\d{2}:\\d{2} - \\d{2}:\\d{2}<br>";
